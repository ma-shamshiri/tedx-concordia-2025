...
export const BlockFooter: React.FC = () => {
  ...
  const sections = [
    {
      ...
      links: [
        { label: "TED", href: "/" },
        { label: "TEDx", href: "/" },
        { label: "TEDxConcordiaUniversity", href: "/" },
      ],
    },
    {
      title: "event",
  ...
  return (
    <Box padding="6rem 2rem" bg={useColorModeValue("#912338", "#232323")}>
      <Flex flexDirection={{ base: "column", lg: "row" }}>
        ...
        <Grid flex={3} templateColumns={isLargeScreen ? "repeat(5, 1fr)" : "1fr"}>
      ...
      <Stack direction="row" justifyContent="center" spacing={10} paddingTop="3rem">
        {[BsLinkedin, FaXTwitter, BsInstagram, BsFacebook].map((Icon, idx) => (
          <IconButton
            key={idx}
